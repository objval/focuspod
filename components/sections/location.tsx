...
import { SCHEDULE, NEARBY_PLACES, SITE_CONFIG } from "@/lib/constants";
...
export function Location() {
  ...
  return (
    ...
    >
      ...
      <FloatingParticles count={16} opacityMax={0.4} />
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          icon={MapPin}
          badgeText="Ubicación Estratégica"
          titlePrefix="En el corazón de "
          titleHighlight="Temuco universitario"
          description="Punto equidistante entre las principales universidades. A pasos de todo."
        />
          ...
          >
            ...
            >
              <Button asChild className="shadow-lg shadow-primary/20">
                <a
                  href={`https://maps.google.com/?q=${encodeURIComponent(SITE_CONFIG.address + ", " + SITE_CONFIG.location + ", " + SITE_CONFIG.country)}`}
                  target="_blank"
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      ...
                      {SITE_CONFIG.location}, {SITE_CONFIG.region}
                    </p>
